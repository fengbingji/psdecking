...
class Navigation extends Model implements Sortable
{
    ...
    public function translation()
    {
        ...
        })->withDefault(function (NavigationTranslation $translation, Navigation $navigation) {
            $translation->name = $navigation->name;
            $translation->keywords = $navigation->keywords;
            $translation->description = $navigation->description;
        });
    }
}
