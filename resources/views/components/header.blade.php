...
<section class="bg-bottom bg-repeat-x" style="background-image: url(/images/scale.png); ">
...
<div class="sticky top-0 z-50 mb-0 hidden bg-white/70 shadow-lg backdrop-blur sm:block" id="sticker">
  <div class="container mx-auto flex flex-col flex-wrap justify-between py-3 font-bold md:flex-row md:items-center">
    <nav class="main-nav flex-1 overflow-hidden hover:overflow-visible">
