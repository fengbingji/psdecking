    ...
    <div class="container mx-auto py-10">
      ...
      <div class="flex flex-col md:flex-row">
        <div class="mb-4 leading-7 md:mr-4">
          <h3 class="mb-5 text-2xl text-gray-800">{{ $blocks['home-about-us']['title'] }}</h3>
          {!! $blocks['home-about-us']['content'] !!}
        </div>
        <div class="border border-gray-200 bg-white p-2">
          <div class="group relative flex">
            {!! $blocks['home-video']['content'] !!}
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="bg-white">
    <div class="container mx-auto py-10 md:flex">
      <div class="sec-testimonials mb-10 md:w-1/2 md:pr-8">
        ...
        <div class="swiper">
          <div class="swiper-wrapper">
            {!! $blocks['home-testimonials']['content'] !!}
          </div>
        </div>
      </div>
      <div class="md:w-1/2">
